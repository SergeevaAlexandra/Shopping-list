...
import type { ItemListSchema } from '../item/schemas'
...
export type CreateShoppingListResponse = z.infer<
  typeof CreateShoppingListResponseSchema
>
...
export type UpdateShoppingListResponse = z.infer<
  typeof UpdateShoppingListSchema
>

export type UpdateShoppingListItems = z.infer<
  typeof UpdateShoppingListItemsSchema
>
