...
export function ShoppingListsPage() {
  ...
  const handleRowClick = (list: ShoppingListModel, e: React.MouseEvent) => {
    ...
    if (!isMenuInteraction) {
      ...
      navigate({
        to: '/shopping-lists/shopping-list/$id',
        params: { id: list.id },
      })
    }
  }
  ...
  const handleShoppingListDialogOpen = (open: boolean) => {
    if (!open) {
  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <Dialog
        ...
        onOpenChange={(open: boolean) => handleShoppingListDialogOpen(open)}
      >
        <DialogContent className="max-h-[50vh] h-[50vh] overflow-y-auto">
          <VisuallyHidden>
